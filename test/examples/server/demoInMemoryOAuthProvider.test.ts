...
import { DemoInMemoryAuthProvider, DemoInMemoryClientsStore } from '../../../src/SESAME/server/demoInMemoryOAuthProvider.js';
import { AuthorizationParams } from '../../../src/server/auth/provider.js';
...
describe('DemoInMemoryAuthProvider', () => {
    ...
    beforeEach(() => {
        ...
        mockResponse = createExpressResponseMock({ trackRedirectUrl: true }) as Response & {
